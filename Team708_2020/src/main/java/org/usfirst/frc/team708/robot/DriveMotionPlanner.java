...
import org.usfirst.frc.team254.lib.trajectory.DistanceView;
import org.usfirst.frc.team254.lib.trajectory.Trajectory;
import org.usfirst.frc.team254.lib.trajectory.TrajectoryIterator;
import org.usfirst.frc.team254.lib.trajectory.TrajectorySamplePoint;
import org.usfirst.frc.team254.lib.trajectory.TrajectoryUtil;
...
import org.usfirst.frc.team254.lib.trajectory.timing.TimingUtil;
...
public class DriveMotionPlanner implements CSVWritable {
    ...
    public void setTargetHeading(double targetHeading, double rotationTimeDuration, Pose2d robotPose){
    	...
    	this.targetHeading = org.usfirst.frc.team1323.lib.util.Util.placeInAppropriate0To360Scope(currentRobotHeading, targetHeading);
