...
public class RightSwitchDropoffPath extends PathfinderPath{
	...
	public RightSwitchDropoffPath(){
		super.points = new Waypoint[]{
				...
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - 1.0, Constants.kRightSwitchCloseCorner.y() + Constants.ROBOT_HALF_LENGTH + 1.25, Pathfinder.d2r(-5.0)),
				new Waypoint(Constants.kRightSwitchFarCorner.x(), Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH + 0.25, 0),
				...
				new Waypoint(Constants.kRightSwitchFarCorner.x() + 2.0, Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH + 1.0, Pathfinder.d2r(15))
		};
		super.maxAccel = 3.25;
		super.maxSpeed = 8.0;
