...
import org.usfirst.frc.team708.robot.DriveMotionPlanner;
import org.usfirst.frc.team708.robot.pathfinder.PathManager;
...
import org.usfirst.frc.team254.lib.trajectory.timing.CurvatureVelocityConstraint;
import org.usfirst.frc.team254.lib.trajectory.timing.TimedState;
import org.usfirst.frc.team254.lib.trajectory.timing.TimingConstraint;
...
public class TrajectoryGenerator {
    ...
    public static final Pose2d kSideStartPose = Pose2d.fromTranslation(new Translation2d(Constants.ROBOT_HALF_WIDTH, 5.5 - Constants.ROBOT_HALF_LENGTH));

    public static final Pose2d kLeftScaleScorePose = new Pose2d(new Translation2d(22.75, Constants.kLeftSwitchCloseCorner.y() - Constants.ROBOT_HALF_LENGTH - 1.0),
        Rotation2d.fromDegrees(0.0));

    public static final Pose2d kSecondRightCubePose = new Pose2d(new Translation2d(Constants.kRightSwitchFarCorner.x() + 3.25, Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH - 3.25),
        Rotation2d.fromDegrees(90.0));

    //4 Cube Switch Auto?
    public static final Translation2d kLeftSwitchScoringPose = new Translation2d(Constants.kLeftSwitchCloseCorner.x() - Constants.ROBOT_HALF_LENGTH - 4.0, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 1.0);
    public static final Translation2d kOuterCubeIntakingPose = new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (3*Constants.kCubeWidth) - 2.0, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 5.1);
    public static final Translation2d kMiddleCubeIntakingPose = new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.5, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 5.2);
    public static final Translation2d kLeftSwitchScoringPose2 = new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.5, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 1.0);
    public static final Translation2d kBottomLeftIntakingPose = new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.25, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 4.25);
    ...
    public class TrajectorySet {
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getAlternateLeftmostCube(){
            ...
            Pose2d firstTranslation = new Pose2d(new Translation2d(22.75, Constants.kLeftSwitchCloseCorner.y() - Constants.ROBOT_HALF_LENGTH - 1.0), Rotation2d.fromDegrees(65.0)).transformBy(Pose2d.fromTranslation(Constants.kVehicleToModuleThree));
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getSecondCubeToRightScale(){
            ...
            waypoints.add(Pose2d.fromTranslation(new Translation2d(Constants.kRightScaleCorner.x() - Constants.ROBOT_HALF_LENGTH + 0.05, Constants.kRightScaleCorner.y() + Constants.ROBOT_HALF_WIDTH + 1.75)));
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getMiddleCubeToRightScale(){
            List<Pose2d> waypoints = new ArrayList<>();
            waypoints.add(new Pose2d(new Translation2d(Constants.kRightSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 2.25, Constants.kRightSwitchCloseCorner.y() - Constants.ROBOT_HALF_WIDTH - 4.6), Rotation2d.fromDegrees(90.0)));
            waypoints.add(Pose2d.fromTranslation(Constants.kRightSwitchCloseCorner.translateBy(new Translation2d(Constants.ROBOT_HALF_WIDTH, Constants.ROBOT_HALF_LENGTH + 1.5))));
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getAlternateMiddleCubeToRightScale(){
            List<Pose2d> waypoints = new ArrayList<>();
            waypoints.add(new Pose2d(new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.65, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 5.2), Rotation2d.fromDegrees(90.0)));
            waypoints.add(Pose2d.fromTranslation(Constants.kRightSwitchCloseCorner.translateBy(new Translation2d(Constants.ROBOT_HALF_WIDTH - 1.0, Constants.ROBOT_HALF_LENGTH + 1.75))));
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getMiddleCubeToLeftScale(){
            List<Pose2d> waypoints = new ArrayList<>();
            waypoints.add(new Pose2d(new Translation2d(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.65, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 5.2), Rotation2d.fromDegrees(-90.0)));
            waypoints.add(Pose2d.fromTranslation(Constants.kLeftSwitchCloseCorner.translateBy(new Translation2d(Constants.ROBOT_HALF_WIDTH, -Constants.ROBOT_HALF_LENGTH - 1.5))));
